...
public class Prova {
	 ...
	 * 100,"cattura",ItemTypes.MONSTERBALL); Item i2 = new Item("Masterball", 10,
	 * 100 ,"cattura 100%",ItemTypes.MONSTERBALL); ======= Player p = new
	 * PlayerImpl("Luca",Gender.MAN, 6969669, new Pair<Integer, Integer>(10, 10));
	 ...
	 * System.out.println(p); GameItems i1 = new HealingItem("Erba",
	 * 10,"cura",GameItemTypes.HEAL); GameItems i2 = new HealingItem("Ampolla",
	 * 10,"cura",GameItemTypes.HEAL,150); >>>>>>>
	 * Player3.0:src/model/player/Prova.java p.addItem(i1); p.addItem(i2);
	 * p.addMonster(m); p.addMonster(m2);
	 * 
	 * System.out.println(p.allItems()); p.removeItem(i1); <<<<<<<
	 * HEAD:src/test/Prova.java System.out.println(p.allItems());
	 */
