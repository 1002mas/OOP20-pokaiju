...
public class NpcTrainerImpl extends NpcSimpleImpl implements NpcTrainer {
	...
	public NpcTrainerImpl(String name, List<String> sentences, Pair<Integer, Integer> position, boolean isVisible,
			boolean isEnabled, List<Monster> monstersOwned, boolean isDefeated) {
