...
public interface PlayerController {
     ...
     * the battle. If there is a npc and is enabled, some text appears.
     * 
     * @return optional string of npc speech
     */
     ...
     * move around.
     * 
     * @return true if in the last {@link #interact() interact()} call the player
     *         interacted with a merchant
     */
    boolean hasMerchantInteractionOccurred();

    /**
     * This function returns a list of merchant's items names.
     * 
    ...
    /**
     * It may be turn true after calling {@link #interact() interact()} or walking
     * in wild monsters area.
     * 
